        ...
        <div class="panel-body">
           ...
           <div class="panel-body text-center">
            	<h2 class="text-danger">  
            		...
            		<span class="glyphicon"><a class="btn btn-primary btn-lg" href="javascript:void(0)" onclick="window.location.href='<%= request.getContextPath()%>/books/appoint?studentId=${cookie['studentId'].value}'" target="_blank">查看我的已预约书籍</a></span>
...
<script src="<%=request.getContextPath()%>/resources/script/bookappointment.js" type="text/javascript"></script>
